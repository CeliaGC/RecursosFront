...
function WheelOfDoom() {
    // Estaba poniendo frontend a una kata en un componente de react y por alguna razón al cargar la página se ejecutaba directamente 
    ...
    function selector(participants){
        ...
        let afortunado = "";
        let result = Math.floor(Math.random() * participants.length);
        afortunado = participants[result];
...
//En el componente WheelOfDoomTrue vamos a corregir estos malos usos y a hacer este componente con prácticas más "Reactónicas", que gracias a ChatGePeTo
//es una de mis palabras favoritas. Ve al coomponente y dale un repaso al código.
